...
contract RequestManager is Ownable {
    ...
    /// The minimum fee paid to the liquidity provider.
    ...
    ///                       A request cannot be fulfilled once its validity period has elapsed.
    ...
    ///
    /// An example (time flows downwards, claimerStake = 10)::
    ///
    ...
    /// requests anymore. Withdrawing deposited funds still works, though.
    ///
    /// .. note:: This function can only be called by the contract owner.
